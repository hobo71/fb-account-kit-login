...
function fbak_register_plugin_settings() {
    ...
    add_settings_section('fbak_plugin_sms_section', '', null, 'fbak_plugin_sms_option');
        ...
        add_settings_field('fbak_sms_new_user_dn', __( 'New User Display Name:', 'fb-account-kit-login' ), 'fbak_sms_new_user_dn_display', 'fbak_plugin_sms_option', 'fbak_plugin_sms_section', array( 'label_for' => 'fbak-sms-reg-user-dn', 'class' => 'fbak-sms-user-dn' ));
    ...
    add_settings_section('fbak_plugin_email_section', '', null, 'fbak_plugin_email_option');
        ...
        add_settings_field('fbak_email_new_user_dn', __( 'New User Display Name:', 'fb-account-kit-login' ), 'fbak_email_new_user_dn_display', 'fbak_plugin_email_option', 'fbak_plugin_email_section', array( 'label_for' => 'fbak-email-reg-user-dn', 'class' => 'fbak-email-user-dn' ));
